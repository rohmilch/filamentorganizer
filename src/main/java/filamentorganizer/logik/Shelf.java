...
public class Shelf extends DefaultTableModel {
	...
	public void addNewSpoolToShelf(int pLength, int pTotalWeigth, String pColour, String pName, String pManufacturer,
			String pMaterial, double pDiameter, double pPrice, int pIdealNoozleTemp, int pIdealBedTemp) {

		FilamentSpool lNewSpool = FilamentSpool.createASpool(pLength, pTotalWeigth, pColour, pName, pManufacturer,
				pMaterial, pDiameter, pPrice, pIdealNoozleTemp, pIdealBedTemp);
